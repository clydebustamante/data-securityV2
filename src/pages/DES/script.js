...
function encrypt(msg, key, numSteps) {
    ...
    /* Step 0 */
    let step = 0;
    let html = '<div class="flex-step" style="display: flex"><div style=" background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1); margin-right: 20px; padding: 40px 40px; border-radius: 20px; width: 100%;"><h3><span class="step" style="padding: 10px 20px; background-color: #DB6868; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 0:</span><br><br> Initialization</h3>';
    html += 'Message: ' + msg + '<br>Key: ' + key +'</div>';

    /* Step 1 */
    if(step++ == numSteps) return html;
    html += '<br /><div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  z-index: -1; padding: 20px 40px; border-radius: 20px; width: 100%;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #6A68DB; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 1:</span> <br><br>Convert to binary</h3>';
    ...
    /* Step 2 */
    if(step++ == numSteps) return html;
    html += '</div><div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  margin-top: 20px; padding: 20px 40px; border-radius: 20px; width: 100%;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #FAA82D; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 2:</span><br><br> Permute the key through the PC-1 table</h3>';
    ...
    html += '<table border="1" cellpadding="5" style="background-color: #FFF; border: 1px solid #DB153C;">';
    let count = 0;
    for(let i = 0; i < 8; i++) {
        html += '<tr>';
        for(let j = 0; j < 7; j++) {
    ...
    html += '<table border="1" cellpadding="5" style="background-color: #FFF; border: 1px solid #DB153C;"><tr>';
    ...
    /* Step 4 */
    if(step++ == numSteps) return html;
    html += '<div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  padding: 20px 40px; border-radius: 20px; width: 100%;margin-top:20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: green; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 4:</span> <br><br>Concatenation</h3><br>';
    ...
    /* Step 5 */
    if(step++ == numSteps) return html;
    html += '<div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #CB2E9F; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 5:</span> <br><br>Permute the key through the PC-2 table</h3><br>';
    ...
    /* Step 6 */
    if(step++ == numSteps) return html;
    html += '<div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #DB153C; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 6:</span><br><br> Permute the message through IP</h3><br>';
    ...
    /* Step 7 */
    if(step++ == numSteps) return html;
    html += '<div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1); padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #EB8151; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 7:</span><br><br> Encode the data</h3><br>';
    ...
    html += '<ul><table border="1" cellpadding="5" style="background-color: #FFF; border: 1px solid #DB153C;">';
    count = 0;
    for(let i = 0; i < 8; i++) {
        html += '<tr>';
        for(let j = 0; j < 4; j++) {
    ...
    for(let i = 0; i < 16; i++) {
        ...
        /* Step 8 */
        if(step++ == numSteps) return html;
        html += '<div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #124B4B; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step ' + step + ':</span> <br><br>Computing ROUND ' + (i + 1) + '</h3>';
    ...
    /* Step 25 */
    if(step++ == numSteps) return html;
    html += '<div style="background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1);  padding: 20px 40px; border-radius: 20px; width: 100%; margin-top: 20px;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #EB8151; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 25:</span> <br><br>Convert back into hexadecimal</h3><br><br>';
