...
{
   html += '<div style=" background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1); margin-top: 20px; padding: 20px 40px; border-radius: 20px; width: 100%;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #FAA82D; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step ' + step + '</span><br><br>' + str + '</h3><br />'
    step++;
}
...
function des_encrypt( inData, Key )
{
   ...
   var i;
   html += '<div style=" background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1); margin-top: 20px; padding: 20px 40px; border-radius: 20px; width: 100%;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #FAA82D; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 3</span><br />Concatenation<br /> Encode the data</h3><br />'
   ...
   html += '<div style=" background: rgba(255, 255, 255, 0.04);border-radius: 16px;box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1);backdrop-filter: blur(4px);bkit-backdrop-filter: blur(4px);border: 1px solid rgba(255, 255, 255, 1); margin-top: 20px; padding: 20px 40px;width: 100%;"><br><h3><span class="step" style="padding: 10px 20px; background-color: #FAA82D; color: white; border-radius: 20px; font-weight: 500; font-size: 14px;">Step 20</span><br><br>Convert back into hexadecimal</h3><br />'
